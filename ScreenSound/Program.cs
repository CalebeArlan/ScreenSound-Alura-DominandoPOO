...
foreach (Artista artista in filme1.Artistas)
{
    Console.WriteLine($"Filme: {filme1.Titulo}, Artista: {artista.Nome}, Idade: {artista.Idade}");
}

foreach(Filme filme in artista1.Filmes)
{
